 ...
 * Vercel serves /api/generate.php from the real serverless function in ../../api/.
 *
 ...
 * started without it answers /api/generate.php with index.html and HTTP 200 - blanking
